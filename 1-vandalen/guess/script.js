...
window.onload = function(){
	...
	var guess = function(number){
		...
		console.log("Det hemliga talet är: " + secret); // Du når den yttre variabeln secret innifrån funktionen.
		console.log("Du gissade: " + number); // Detta nummer är det som användaren gissade på.
			
		// Plats för förändring.
		if(number==secret){
			console.log("Grattis du vann! Det hemliga talet var X och du behövde Y gissningar för att hitta det.");
